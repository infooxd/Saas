...
const PreviewPage = () => {
  ...
  const loadProject = async () => {
    try {
      ...
      if (slug) {
        ...
        response = await axios.get(`/api/projects/slug/${slug}/preview`);
      } else if (projectId) {
        // Preview by project ID (for editor preview)
        response = await axios.get(`/api/projects/${projectId}/preview`);
      } else {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <meta name="description" content={project.description || 'Project preview'} />
      ...
      {blocks.length > 0 ? (
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Empty Project</h1>
            <p className="text-gray-600">This project doesn't have any content yet.</p>
          </div>
        </div>
      )}
      ...
      <div className="bg-gray-50 py-4 text-center border-t">
        <p className="text-sm text-gray-500">
          Powered by <span className="font-semibold text-purple-600">Oxdel</span>
        </p>
      </div>
    </div>
  );
