/*
  ...
  1. New Columns
    - `email_verification_token` (text) - Token untuk verifikasi email
    - `email_verification_expiry` (timestamp) - Waktu kedaluwarsa token
  
  2. Updates
    - Modify existing users table to support email verification
*/
